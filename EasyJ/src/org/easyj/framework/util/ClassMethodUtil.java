...
import org.easyj.framework.core.annotation.KeyType;
import org.easyj.framework.core.annotation.Table;
import org.easyj.framework.core.data.BaseDaoAssist;
/*************************************
...
public class ClassMethodUtil {
	...
	//反射调用bean 的set方法
		public static <T>void getInvokeSetParamsBean(T clazz,Method setMethod,String value) throws IllegalAccessException,
	...
	public static String getTableName(Object obj){
		...
		if(!isTableName) throw new EasyJException(clazz + " not extis table annotation ");
		Table table = clazz.getAnnotation(Table.class);
		String tableName = table.name();
		if(StringUtils.isEmpty(tableName)) throw new EasyJException(clazz + " table annotation name is null");
		return tableName;
	}
	//判断该方法是否为is/get方法
	...
	public static String getColumnName(Method method){
		...
		if(!isColumn) throw new EasyJException("method " + method.getName() +" not exist column annotation");
